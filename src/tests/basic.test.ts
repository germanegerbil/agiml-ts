...
const MODEL_ID = 'gpt-4o'; //if tests fail due to malformed AGIML output from the assistant, change this to gpt-4o, o1-mini, o1-preview, or your favorite high end LLM
...
describe('LLM Client Basic Tests', () => {
  ...
  test('AGIML Middleware Integration', async () => {
    ...
    const config: AgentConfig = {
      ...baseConfig,
      system_prompt:
        'You are a creative AI assistant who loves to generate images.',
    };
    ...
    const response = await agent.performInference(
      'Create an image of a happy robot.'
    );
